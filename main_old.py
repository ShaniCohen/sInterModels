...
from data_handlers_old.data_handler import DataHandler
...
def train_and_evaluate(model_h, train_fragments: Dict[str, object], test: Dict[str, object], **kwargs) -> \
    ...
    predictions, training_history = \
        model_h.train_and_test_graph_model(X_train=train_fragments['X'], y_train=train_fragments['y'], X_test=test['X'],
